  ...
  <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6 text-gray-900 dark:text-gray-100">
      ...
      <div
        ...
        class="mb-4 p-2 bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100 rounded flex justify-between items-center"
      >
      ...
      <div
        ...
        class="mb-4 p-2 bg-red-100 text-red-800 dark:bg-red-800 dark:text-red-100 rounded flex justify-between items-center"
      >
...
const syncBackgroundCheck = async (candidateId, backgroundCheckId) => {
  ...
  try {
    const response = await axios.post(
      `/api/ats/candidates/${candidateId}/background-checks/${backgroundCheckId}/sync`
    );
